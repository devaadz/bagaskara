    ...
    public function payment(Request  $request)
    {
        ...
        if ($request->order_type == 1) {
           $order = Order::find($request->order_id);
            ...
            // dd("else", $orderak, "space", $ordercuy);
        ...
        //deva new function
        // Move this function outside of any other function, directly inside the class
    
    // Place this function after the closing bracket of your previous function, so it is directly inside the class
