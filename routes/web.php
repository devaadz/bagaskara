...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::prefix('reports')->group(function () {
            Route::get('/', [SalesSummaryController::class, 'index'])->name('reports.index');
            Route::get('/daily', [SalesSummaryController::class, 'daily'])->name('reports.daily');
            Route::get('/weekly', [SalesSummaryController::class, 'weekly'])->name('reports.weekly');
            Route::get('/monthly', [SalesSummaryController::class, 'monthly'])->name('reports.monthly');
            Route::get('/yearly', [SalesSummaryController::class, 'yearly'])->name('reports.yearly');
    ...
    Route::prefix('operator')->middleware('operator')->group(function () {
        ...
        //deva
        Route::get('/report/category', [SalesSummaryController::class, 'categoryReport']);
        Route::get('/report/best-products', [SalesSummaryController::class, 'bestSellingProducts']);
        //deva end
    });
});
